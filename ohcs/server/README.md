...
**the Flag** (caught the machine) · **the Looper** (the human most mistaken *for* the machine; 4+ seats).
...
4. **Table size / Looper** — Looper needs 4+ seats; `TABLE_TARGET=4` by default.
